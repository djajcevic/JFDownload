...
Pod::Spec.new do |s|
  ...
  # s.authors          = { "djajcevic" => "denis.jajcevic@gmail.com", "other author" => "email@address.com" }
  # s.author           = 'djajcevic', 'other author'
  # s.social_media_url = "http://twitter.com/djajcevic"
  ...
  s.source       = { :git => "http://EXAMPLE/JFDownload.git", :tag => "0.0.1" }
